<div>
            ...
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        ...
                        <p class="text-xs text-green-600 dark:text-green-400">+<?php echo e($stats['new_users']); ?> new</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        ...
                        <p class="text-xs text-yellow-600 dark:text-yellow-400"><?php echo e($stats['pending_orders']); ?> pending</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        ...
                        <p class="text-xs text-green-600 dark:text-green-400">+Rp <?php echo e(number_format($stats['period_revenue'], 0, ',', '.')); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-dark-elevated overflow-hidden shadow-lg rounded-xl border border-slate-200 dark:border-dark-border">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        <p class="text-sm font-medium text-slate-500 dark:text-slate-400">Credits Given</p>
                        <p class="text-2xl font-bold text-slate-900 dark:text-white"><?php echo e(number_format($stats['total_credits_given'], 0, ',', '.')); ?></p>
                        <p class="text-xs text-purple-600 dark:text-purple-400">+<?php echo e(number_format($stats['period_credits'], 0, ',', '.')); ?> new</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div class="bg-white dark:bg-dark-elevated rounded-xl shadow-lg border border-slate-200 dark:border-dark-border overflow-hidden">
            <div class="px-5 py-4 border-b border-slate-200 dark:border-dark-border">
                <h3 class="text-base font-semibold text-slate-900 dark:text-white">New Users</h3>
            </div>
            <div class="p-5">
    ...
    <div class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div class="bg-white dark:bg-dark-elevated rounded-xl shadow-lg border border-slate-200 dark:border-dark-border overflow-hidden">
            <div class="px-5 py-4 border-b border-slate-200 dark:border-dark-border">
                <h3 class="text-base font-semibold text-slate-900 dark:text-white">Order Status</h3>
            </div>
        ...
        <div class="bg-white dark:bg-dark-elevated rounded-xl shadow-lg border border-slate-200 dark:border-dark-border overflow-hidden">
            <div class="px-5 py-4 border-b border-slate-200 dark:border-dark-border flex items-center justify-between">
                <h3 class="text-base font-semibold text-slate-900 dark:text-white">Recent Orders</h3>
                <a href="<?php echo e(route('admin.orders.index')); ?>" class="text-sm text-primary-600 hover:text-primary-700 dark:text-primary-400">View all</a>
            </div>
            <div class="divide-y divide-slate-100 dark:divide-dark-border">
                ...
                <div class="px-5 py-3 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xs text-slate-500 dark:text-slate-400"><?php echo e($order->user?->name ?? 'Guest'); ?></p>
                    </div>
                ...
                <div class="px-5 py-8 text-center text-sm text-slate-500 dark:text-slate-400">No orders yet</div>
        ...
        <div class="bg-white dark:bg-dark-elevated rounded-xl shadow-lg border border-slate-200 dark:border-dark-border overflow-hidden">
            <div class="px-5 py-4 border-b border-slate-200 dark:border-dark-border flex items-center justify-between">
                <h3 class="text-base font-semibold text-slate-900 dark:text-white">Recent Users</h3>
                <a href="<?php echo e(route('admin.users.index')); ?>" class="text-sm text-primary-600 hover:text-primary-700 dark:text-primary-400">View all</a>
            </div>
            <div class="divide-y divide-slate-100 dark:divide-dark-border">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                <div class="px-5 py-8 text-center text-sm text-slate-500 dark:text-slate-400">No users yet</div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
    </div>
...
<?php $__env->stopPush(); ?><?php /**PATH D:\Installed\Apps\laragon\www\gramsea\resources\views/admin/livewire/dashboard.blade.php ENDPATH**/ ?>