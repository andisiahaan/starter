    ...
    <div class="flex items-center justify-between h-16 px-4 md:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <nav class="hidden md:flex items-center text-sm">
                <a href="<?php echo e(route('admin.index')); ?>" class="text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-white transition-colors">
                    Admin
                </a>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!request()->routeIs('admin.index')): ?>
                <svg class="w-4 h-4 mx-2 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
                <span class="text-slate-900 dark:text-white font-medium">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->routeIs('admin.users.*')): ?>
                    Users
                    <?php elseif(request()->routeIs('admin.roles.*')): ?>
                    Roles
                    <?php elseif(request()->routeIs('admin.permissions.*')): ?>
                    Permissions
...
?>
            ...
            <div class="relative">
                ...
                <div x-show="userMenuOpen"
                    ...
                    <div class="py-1">
                        <a href="<?php echo e(route('app.index')); ?>" class="flex items-center gap-3 px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
                            <svg class="w-4 h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
</header><?php /**PATH D:\Installed\Apps\laragon\www\starter\resources\views/admin/layouts/partials/topbar.blade.php ENDPATH**/ ?>