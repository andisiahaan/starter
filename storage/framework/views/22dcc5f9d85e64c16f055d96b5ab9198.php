<div class="flex flex-col bg-white dark:bg-dark-elevated rounded-lg overflow-hidden">
    ...
    <div class="flex items-center justify-between px-5 py-4 border-b border-slate-200 dark:border-dark-border">
        <h3 class="text-lg font-semibold text-slate-900 dark:text-white">
            <?php echo e($permissionId ? __('admin.permissions.modals.edit.title') : __('admin.permissions.modals.create.title')); ?>
    ...
    <div class="p-5">
        <form wire:submit="save" class="space-y-4">
            <div>
                <label for="name" class="block text-sm font-medium text-slate-700 dark:text-slate-300"><?php echo e(__('admin.permissions.modals.create.name')); ?></label>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                <label for="guard_name" class="block text-sm font-medium text-slate-700 dark:text-slate-300"><?php echo e(__('admin.permissions.modals.create.guard')); ?></label>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2"><?php echo e(__('admin.permissions.modals.create.roles')); ?></label>
    ...
    <div class="flex items-center justify-end gap-3 px-5 py-4 border-t border-slate-200 dark:border-dark-border bg-slate-50 dark:bg-dark-soft">
        <button wire:click="$dispatch('closeModal')" class="px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 bg-white dark:bg-dark-muted border border-slate-300 dark:border-dark-border rounded-lg hover:bg-slate-50 dark:hover:bg-dark-border transition">
            <?php echo e(__('admin.permissions.modals.create.cancel')); ?>
        ...
        <button wire:click="save" class="px-4 py-2 text-sm font-medium text-white bg-primary-600 border border-transparent rounded-lg hover:bg-primary-700 transition" wire:loading.attr="disabled">
            <span wire:loading.remove wire:target="save"><?php echo e($permissionId ? __('admin.permissions.modals.create.update') : __('admin.permissions.modals.create.create')); ?></span>
            <span wire:loading wire:target="save"><?php echo e(__('admin.permissions.modals.create.saving')); ?></span>
        </button>
    </div>
</div>
<?php /**PATH D:\Installed\Apps\laragon\www\starter\resources\views/admin/livewire/permissions/modals/create-edit-permission-modal.blade.php ENDPATH**/ ?>