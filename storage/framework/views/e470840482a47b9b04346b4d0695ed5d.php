...
<aside :class="{ 'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen }"
    ...
    <nav class="flex-1 overflow-y-auto custom-scrollbar px-3 py-4 space-y-1">
        ...
        <div class="pt-4">
            ...
            <!-- Roles with Submenu -->
            <div x-data="{ open: <?php echo e(request()->routeIs('admin.roles.*') ? 'true' : 'false'); ?> }">
                <button @click="open = !open"
            ...
            <a href="<?php echo e(route('admin.permissions.index')); ?>"
                class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.permissions.*') ? 'bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400 border-l-2 border-primary-500' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 hover:text-slate-900 dark:hover:text-white'); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
</aside><?php /**PATH D:\Installed\Apps\laragon\www\gramsea\resources\views/admin/layouts/partials/sidebar.blade.php ENDPATH**/ ?>