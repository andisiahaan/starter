...
<body class="font-sans antialiased h-full bg-slate-100 text-slate-900 dark:bg-dark-base dark:text-white"
    ...
    <div class="min-h-full flex">
        ...
        <div class="flex-1 flex flex-col min-w-0 md:pl-64">
            <!-- Admin Topbar -->
            <?php echo $__env->make('admin.layouts.partials.topbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <main class="flex-1 overflow-y-auto focus:outline-none p-4 md:p-6 lg:p-8">
                <?php echo $__env->make('admin.layouts.partials.alert', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php echo e($slot); ?>
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-4122037192-0', $key);
...
</html><?php /**PATH D:\Installed\Apps\laragon\www\gramsea\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>