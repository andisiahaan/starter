...
<aside x-data="{ activeMenu: '<?php echo e(request()->routeIs('app.index') ? 'dashboard' : ''); ?>' }"
    ...
    <nav class="flex-1 overflow-y-auto custom-scrollbar px-3 py-4 space-y-1">
        ...
        <div class="pt-4">
            <p class="px-3 mb-2 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider">
                <?php echo e(__('common.nav.billing')); ?>
            ...
            <a href="<?php echo e(route('app.orders.index')); ?>"
                ...
                <?php echo e(__('common.nav.my_orders')); ?>
        ...
        <div class="pt-4">
            <p class="px-3 mb-2 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider">
                <?php echo e(__('common.nav.support')); ?>
            ...
            <a href="<?php echo e(route('app.tickets.index')); ?>"
                ...
                <?php echo e(__('common.nav.support_tickets')); ?>
    ...
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="pt-4">
            <p class="px-3 mb-2 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider">
                <?php echo e(__('common.nav.developer')); ?>
            ...
            <a href="<?php echo e(route('app.api-tokens.index')); ?>"
                ...
                <?php echo e(__('common.nav.api_tokens')); ?>
            ...
            <a href="<?php echo e(route('docs.api')); ?>"
                ...
                <?php echo e(__('common.nav.api_docs')); ?>
        ...
        <div class="pt-4">
            <p class="px-3 mb-2 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider">
                <?php echo e(__('common.nav.administration')); ?>
            ...
            <a href="<?php echo e(route('admin.index')); ?>"
                ...
                <?php echo e(__('common.nav.admin_panel')); ?>
