<div>
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-xl font-semibold text-slate-900 dark:text-white"><?php echo e(__('admin.orders.title')); ?></h1>
            <p class="mt-2 text-sm text-slate-500 dark:text-slate-400"><?php echo e(__('admin.orders.description')); ?></p>
        </div>
    </div>

    <!-- Filters -->
    <div class="mt-4 flex flex-col sm:flex-row gap-4">
        <input wire:model.live.debounce.300ms="search" type="text" placeholder="<?php echo e(__('admin.orders.filters.search')); ?>"
        ...
        <select wire:model.live="statusFilter" class="block w-full sm:w-48 rounded-md border-slate-300 dark:border-dark-border shadow-sm focus:border-primary-500 focus:ring-primary-500 bg-white dark:bg-dark-elevated text-slate-900 dark:text-white sm:text-sm">
            <option value=""><?php echo e(__('admin.orders.filters.all_status')); ?></option>
                ...
                <div class="overflow-hidden shadow ring-1 ring-slate-200 dark:ring-dark-border md:rounded-lg">
                    <table class="min-w-full divide-y divide-slate-200 dark:divide-dark-border">
                        <thead class="bg-slate-50 dark:bg-dark-soft">
                            <tr>
                                <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-slate-900 dark:text-white sm:pl-6"><?php echo e(__('admin.orders.table.order')); ?></th>
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-slate-900 dark:text-white"><?php echo e(__('admin.orders.table.user')); ?></th>
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-slate-900 dark:text-white"><?php echo e(__('admin.orders.table.product')); ?></th>
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-slate-900 dark:text-white"><?php echo e(__('admin.orders.table.amount')); ?></th>
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-slate-900 dark:text-white"><?php echo e(__('admin.orders.table.status')); ?></th>
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-slate-900 dark:text-white"><?php echo e(__('admin.orders.table.date')); ?></th>
                        ...
                        <tbody class="divide-y divide-slate-200 dark:divide-dark-border bg-white dark:bg-dark-base">
                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-dark-elevated transition-colors">
                                <td class="whitespace-nowrap py-4 pl-4 pr-3 sm:pl-6">
                                    ...
                                    <span class="inline-flex items-center text-xs text-green-600 dark:text-green-400">
                                        ...
                                        <?php echo e(__('admin.orders.credit_given')); ?>
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm">
                                    ...
                                    <?php else: ?>
                                    <span class="text-slate-400 dark:text-slate-500"><?php echo e(__('admin.orders.user_deleted')); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm">
                                    <div class="text-slate-900 dark:text-white"><?php echo e($order->product_name); ?></div>
                                    <div class="text-xs text-primary-600 dark:text-primary-400"><?php echo e(number_format($order->credit_amount, 0, ',', '.')); ?> <?php echo e(__('admin.orders.credits')); ?></div>
                                </td>
                                ...
                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                    <button wire:click="$dispatch('openModal', { component: 'admin.orders.modals.order-detail-modal', arguments: { orderId: <?php echo e($order->id); ?> } })" class="text-primary-600 dark:text-primary-400 hover:text-primary-500 dark:hover:text-primary-300 mr-3"><?php echo e(__('admin.orders.actions.view')); ?></button>
                                    <button wire:click="$dispatch('openModal', { component: 'admin.orders.modals.update-order-status-modal', arguments: { orderId: <?php echo e($order->id); ?> } })" class="text-yellow-600 dark:text-yellow-400 hover:text-yellow-500 dark:hover:text-yellow-300"><?php echo e(__('admin.orders.actions.status')); ?></button>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center text-sm text-slate-500 dark:text-slate-400">
                                    <?php echo e(__('admin.orders.empty')); ?>
