...
<head>
    ...
    <title>{{ setting('main.name', config('app.name')) }} - Modern SaaS Platform</title>
    <meta name="description" content="{{ setting('main.description', 'Build and scale your business with our powerful SaaS platform.') }}">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-xl font-bold">{{ setting('main.name', config('app.name')) }}</span>
                </div>
                ...
                <div class="flex items-center gap-3">
                    <a href="{{ route('login') }}" class="text-slate-300 hover:text-white transition-colors px-4 py-2">
                        Login
                    </a>
                    <a href="{{ route('register') }}" class="bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 px-5 py-2 rounded-full font-medium transition-all hover:scale-105">
                        Get Started
                    </a>
                </div>
            </div>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="text-center">
                ...
                <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="800" class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ route('register') }}" class="group relative inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full font-semibold text-lg transition-all hover:scale-105 pulse-glow">
                        Start Free Trial
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                ...
                <div data-aos="fade-up" data-aos-delay="100" class="p-8 rounded-2xl bg-white/5 border border-white/10">
                    ...
                    <a href="{{ route('register') }}" class="block w-full py-3 text-center rounded-full border border-white/20 hover:bg-white/5 transition-colors font-medium">
                        Get Started
                    </a>
                </div>
                ...
                <div data-aos="fade-up" data-aos-delay="200" class="relative p-8 rounded-2xl bg-gradient-to-b from-indigo-500/20 to-purple-500/20 border border-indigo-500/30 scale-105">
                    ...
                    <a href="{{ route('register') }}" class="block w-full py-3 text-center rounded-full bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 transition-colors font-medium">
                        Start Free Trial
                    </a>
                </div>
            ...
            <div data-aos="fade-up" class="relative p-12 rounded-3xl overflow-hidden">
                ...
                <div class="relative text-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="{{ route('register') }}" class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-indigo-600 rounded-full font-semibold text-lg hover:bg-slate-100 transition-all hover:scale-105">
                            Start Free Trial
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-4 gap-8 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-slate-400">
                        <li><a href="{{ route('page.show', 'about') }}" class="hover:text-white transition-colors">About Us</a></li>
                        <li><a href="{{ route('page.show', 'contact') }}" class="hover:text-white transition-colors">Contact Us</a></li>
                        <li><a href="{{ route('docs.api') }}" class="hover:text-white transition-colors">API Docs</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-slate-400">
                        ...
                        <li><a href="{{ route('page.show', 'terms-of-service') }}" class="hover:text-white transition-colors">Terms of Service</a></li>
                        <li><a href="{{ route('page.show', 'refund-policy') }}" class="hover:text-white transition-colors">Refund Policy</a></li>
            ...
            <div class="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-white/5">
                <p class="text-slate-400 text-sm">
                    © {{ date('Y') }} {{ setting('main.name', config('app.name')) }}. All rights reserved.
                </p>
