<div class="flex flex-col bg-white dark:bg-dark-elevated rounded-lg overflow-hidden">
    ...
    <div class="flex items-center justify-between px-5 py-4 border-b border-slate-200 dark:border-dark-border">
        <h3 class="text-lg font-semibold text-slate-900 dark:text-white">{{ __('Delete Role') }}</h3>
        ...
        <div class="flex items-start gap-4">
            ...
            <div>
                <p class="text-slate-700 dark:text-slate-300">
                    Are you sure you want to delete the role <strong class="text-slate-900 dark:text-white">{{ $role?->name }}</strong>?
                </p>
                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                    This action cannot be undone. All users with this role will lose their associated permissions.
                </p>
            </div>
        </div>
    </div>
