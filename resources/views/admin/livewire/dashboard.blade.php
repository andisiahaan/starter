            ...
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        ...
                        <p class="text-xs text-green-600 dark:text-green-400">+{{ $stats['new_users'] }} new</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        ...
                        <p class="text-xs text-green-600 dark:text-green-400">+Rp {{ number_format($stats['period_revenue'], 0, ',', '.') }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        ...
                        <p class="text-xs text-purple-600 dark:text-purple-400">+{{ number_format($stats['period_credits'], 0, ',', '.') }} new</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div class="bg-white dark:bg-dark-elevated rounded-xl shadow-lg border border-slate-200 dark:border-dark-border overflow-hidden">
            <div class="px-5 py-4 border-b border-slate-200 dark:border-dark-border flex items-center justify-between">
                ...
                <a href="{{ route('admin.orders.index') }}" class="text-sm text-primary-600 hover:text-primary-700 dark:text-primary-400">View all</a>
            </div>
            <div class="divide-y divide-slate-100 dark:divide-dark-border">
                ...
                <div class="px-5 py-3 flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xs text-slate-500 dark:text-slate-400">{{ $order->user?->name ?? 'Guest' }}</p>
                    </div>
        ...
        <div class="bg-white dark:bg-dark-elevated rounded-xl shadow-lg border border-slate-200 dark:border-dark-border overflow-hidden">
            <div class="px-5 py-4 border-b border-slate-200 dark:border-dark-border flex items-center justify-between">
                ...
                <a href="{{ route('admin.users.index') }}" class="text-sm text-primary-600 hover:text-primary-700 dark:text-primary-400">View all</a>
            </div>
            <div class="divide-y divide-slate-100 dark:divide-dark-border">
