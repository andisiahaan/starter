<div class="flex flex-col bg-white dark:bg-dark-elevated rounded-lg overflow-hidden">
    ...
    <div class="flex items-center justify-between px-5 py-4 border-b border-slate-200 dark:border-dark-border">
        <h3 class="text-lg font-semibold text-slate-900 dark:text-white">Delete Post</h3>
        ...
        <div class="flex items-start gap-4">
            ...
            <div>
                <p class="text-sm text-slate-700 dark:text-slate-300">
                    Are you sure you want to delete <strong class="text-slate-900 dark:text-white">"{{ $postTitle }}"</strong>? This action cannot be undone.
                </p>
            </div>
        </div>
    </div>
