<div>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Credit History</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Your credit transaction history</p>
        </div>
    ...
    <div class="bg-white dark:bg-dark-elevated rounded-xl shadow-sm border border-gray-200 dark:border-dark-border overflow-hidden">
        ...
        <div class="flex items-center justify-between p-4 border-b border-gray-100 dark:border-dark-border last:border-b-0 hover:bg-gray-50 dark:hover:bg-dark-soft transition-colors">
            ...
            <div class="text-right">
                ...
                <p class="text-xs text-gray-400">Balance: {{ number_format($log->balance_after, 0, ',', '.') }}</p>
            </div>
        </div>
        @empty
        <div class="p-8 text-center">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Your credit history will appear here.</p>
        </div>
        @endforelse
    </div>
