<header class="sticky top-0 z-30 bg-white/80 dark:bg-dark-base/80 backdrop-blur-lg border-b border-slate-200 dark:border-dark-border">
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open"
                    ...
                    <div class="py-1">
                        ...
                        <!-- Credits -->
                        <a href="{{ route('app.credits.index') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
                            <svg class="w-4 h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          d="M4 10c0 1.657 3.582 3 8 3s8-1.343 8-3M4 14c0 1.657 3.582 3 8 3s8-1.343 8-3" />
                            ...
                            {{ __('common.nav.credits') }} : {{ setting('main.currency', '-') }}{{ number_format(Auth::user()->credit, 0, ',', '.') }}
                        </a>
